...
TEXTURING_T0_T18 STATIC HARDENING COMPLETE
ANIMATION_D1 EFFECT MUTATION SOURCE IN LOCAL
ANIMATION_D2 CONTROLLER EFFECT SOURCE IN LOCAL
ANIMATION_D3 MATH PROPERTY SOURCE IN LOCAL
ANIMATION_D4 TIMELINE BATCH OWNERSHIP FIXED
ANIMATION_D5 EFFECT SUMMARY COUNTS FIXED
...
NO_LOCAL_RUN_ACTIVE
LOCAL_CODEX_EFFICIENCY_TEST_DEFERRED_BY_USER
LOCAL_ACCEPTANCE_DEFERRED_NOT_CURRENT_NEXT_STEP
```
...
65c2a96029ed31d4ce53cea2e64fb62772d6992c
merge(mcp): land shared schema compaction
```
