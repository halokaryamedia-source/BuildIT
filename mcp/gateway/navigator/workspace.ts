...
export type NavigatorWorkspaceProjection = {
  available: boolean;
...
type CachedWorkspace = {
  signature: string;
  projection: NavigatorWorkspaceProjection;
};
...
export async function readWorkspaceProjection(
  status: GatewayRuntimeStatus,
  workspacePath?: string | null
): Promise<NavigatorWorkspaceProjection> {
  ...
  try {
    ...
    const projection: NavigatorWorkspaceProjection = {
      available: true,
