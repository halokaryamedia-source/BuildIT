...
replace_once(
    ...
    "Professional motion has no keyframe-count, FPS, or Bezier-complexity target. Choose timing/loop/bones from the motion. `manage_keyframes` preserves explicit Molang transform strings; never evaluate or guess-bake them.",
)
replace_once(
    ".agents/skills/blockit-bedrock-animation/SKILL.md",
